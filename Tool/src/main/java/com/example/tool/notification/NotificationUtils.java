package com.example.tool.notification;
 ...
 * @version 1.0.0
 * @createDate 2022/8/23 8:41
 * @description
 * @updateUser hahajing
 * @updateDate 2022/8/23 8:41
 * @updateRemark
 *
 * //普通通知栏消息
 * NotificationUtils notificationUtils = new NotificationUtils(this, notifyId, channelId, R
 * .mipmap.ic_launcher, "标题", "内容");
 ...
 * notificationUtils.completeProgress("完成","下载完成！");
 */
public class NotificationUtils extends ContextWrapper {
    ...
    public void notified(Intent intent) {
        PendingIntent pendingIntent = PendingIntent.getActivity(getApplicationContext(), UUID.randomUUID().hashCode(), intent, PendingIntent.FLAG_UPDATE_CURRENT);
